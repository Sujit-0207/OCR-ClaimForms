...
def process_content_with_gemini(extracted_text: str, file_type: str) -> dict:
    """
    Sends extracted text to Gemini to be structured into JSON.
    """
    ...
    2. Extract key information relevant to that document type.
    3. Structure the output into a valid JSON object.

    The JSON must include:
    - "document_type": The detected type of document.
    - "extracted_data": A nested object containing the fields you found.
...
def main():
    ...
    structured_data = process_content_with_gemini(extracted_text, file_type_label)
