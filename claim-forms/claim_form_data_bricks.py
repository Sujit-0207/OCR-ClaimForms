...
vault = vault.vault(dbutils)

API_KEY = vault.get_hashicorp_key_value(
    "LLM_API",
    "NPE_POENAI_API_KEY"
)
...
def structure_with_gemini(text, filename, images_list=None):
...
def main_pipeline(file_path):
    ...
    # Structure data
    structured_data = structure_with_gemini(full_text, os.path.basename(file_path), images_list)
